...
{
    public class EndMenuPanelUI : Singleton<EndMenuPanelUI>
    {
        //[Header("InitialMenu")]
       ...
       // [Space]
        ...
        public static void EndMenuSetActive(bool active)
        {
            Instance.gameOverMenu.SetActive(active);
            Instance._gameOverMenuCanvasGroup.alphaTransition(active ? 1f : 0f, 2f);
        }
